PANDOC_OPTS+=-V links-as-notes -V geometry:left=1.5in -V geometry:right=1in -V geometry:top=1in -V geometry:bottom=1in -Vdocumentclass=article -Vtoc --latex-engine=xelatex -V numbersections
